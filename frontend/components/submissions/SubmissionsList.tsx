...
const SubmissionsListPage: React.FC = () => {
  ...
  const loadSubmissions = async () => {
    try {
      ...
      const response: PaginatedResponse<{ submissions: Submission[] }> = 
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Please sign in to view your submissions.</p>
          <button
          ...
          <div className="bg-white rounded-lg shadow-sm border p-8 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Create your first StoryMap submission to get started in the competition.
              </p>
              <button
                onClick={() => router.push('/submissions/create')}
